...
-- Apply with psql or your migration runner.
...
-- We simply include the authoritative schema file content here for v1.

-- ====== START schema_v1.sql content ======
-- (Copied inline to keep migration self-contained)
