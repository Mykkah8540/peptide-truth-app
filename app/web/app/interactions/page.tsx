...
export default async function InteractionsPage() {
 ...
 const mapping =
  rev && typeof rev === "object" && (rev as any).mapping && typeof (rev as any).mapping === "object"
   ? (rev as any).mapping
   : {};

 const countFor = (slug: string) => (Array.isArray((mapping as any)?.[slug]) ? (mapping as any)[slug].length : 0);
 ...
 return (
  <main style={{ maxWidth: 920, margin: "0 auto", padding: "24px 16px" }}>
   ...
   <p style={{ marginTop: 10, opacity: 0.85, lineHeight: 1.5 }}>
    Interaction classes are <strong>educational context tags</strong> that help you review peptide content with safety in mind (e.g.,
    “anticoagulants/antiplatelets”, “SSRIs/SNRIs”, “immunosuppressants”).
   </p>
