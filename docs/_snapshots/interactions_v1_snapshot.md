...
- Generated (UTC): **2026-01-23 14:21:17Z**
- Repo: `peptide-truth-app`
- Branch: `feat/ui-risk-badge`
- Commit: `f9f8dd8`
- Describe: `v1.0.0-interactions-12-gf9f8dd8-dirty`

## Source Artifacts

- Taxonomy: `content/_taxonomy/interaction_classes_v1.json`
- Reverse index: `content/_index/interactions_to_peptides_v1.json`
- Coverage report: `data/reports/interactions_coverage_report_v1.json`
...
- `Peptides tagged` is derived from the reverse index.
- A class existing in taxonomy but missing in the reverse index will show as 0.
